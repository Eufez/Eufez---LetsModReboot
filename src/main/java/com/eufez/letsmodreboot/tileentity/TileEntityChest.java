package com.eufez.letsmodreboot.tileentity;

import com.eufez.letsmodreboot.init.ModBlocks;
import com.eufez.letsmodreboot.reference.Names;
import com.eufez.letsmodreboot.reference.Sounds;
...
public class TileEntityChest extends TileEntityLMRB implements IInventory
{
    /**
    ...
    {
        return this.hasCustomName() ? this.getCustomName() : Names.Containers.CHEST;
    }
